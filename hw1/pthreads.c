/* Example of using pthreads
   ...
   Parallel design patterns: data patallel; loop parallel;
   fork join; mutual exclusion */
...
double gPi = 0.0; //global accumulator for areas computer
...
void *Area(void *pArg){
  ...
  gPi += partialSum; // ad partial to global final answer
